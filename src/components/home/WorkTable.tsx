        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-[1fr_3fr] md:gap-0">
          ...
          <div>
            ...
            <div className="flex justify-between border-b border-border pb-3">
              <span className="text-base text-text-secondary">Product</span>
              <span className="text-base text-text-secondary">Type</span>
            </div>
            ...
            {workTable.map((entry, i) => (
              ...
              >
                <span className="text-base text-text-primary">{entry.product}</span>
                <span className="text-base text-text-secondary">{entry.type}</span>
              </div>
            ))}
          </div>
        </div>
