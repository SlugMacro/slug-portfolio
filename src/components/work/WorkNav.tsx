    ...
    <section className="mt-16 md:mt-24">
      <Container>
        <div className="grid grid-cols-2 border-t border-b border-border">
          ...
          >
            <span className="text-base tracking-wide text-text-secondary">
              Prev
            </span>
            <p className="mt-1 text-base font-medium tracking-wide text-text-primary transition-opacity duration-300 group-hover:opacity-60">
              {prevWork.data.title}
            </p>
          </Link>
